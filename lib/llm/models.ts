...
export const chatModels: ChatModel[] = [
  ...
  },
  {
    ...
    provider: "anthropic",
    description: "Fast Anthropic model for concise responses",
    supportsTools: true,
    supportsVision: true,
    supportsReasoning: false,
  },
  {
    ...
    provider: "anthropic",
    description: "Stronger Anthropic model for document work",
    supportsTools: true,
    supportsVision: true,
    supportsReasoning: true,
  },
  {
    ...
    provider: "google",
    description: "Low-latency Google model for chat and retrieval",
    supportsTools: true,
    supportsVision: true,
    supportsReasoning: false,
  },
  {
    ...
    name: "Gemini 2.5 Pro",
    provider: "google",
    description: "Higher-capability Google model for longer context",
    supportsTools: true,
    supportsVision: true,
    supportsReasoning: true,
  },
  {
    ...
    provider: "openai",
    description: "Any OpenAI-compatible endpoint configured in env",
    supportsTools: true,
